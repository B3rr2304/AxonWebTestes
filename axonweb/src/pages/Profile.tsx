          ...
          >
            ...
            <div className="mb-4">
              <input
                ...
                className="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-3.5 text-sm font-medium text-white outline-none ring-purple-500/50 transition placeholder:text-white/25 focus:border-purple-400/40 focus:ring-2"
              />
